...
FCKTools.GetElementPosition = function( el, relativeWindow )
{
	...
	// For some reason, the code is not arriving at the edit_content div via offsetParent
	// Hacking this in to manually compute the correct Y coordinate
	c.Y -= oWindow.document.getElementById("edit_content").scrollTop;
